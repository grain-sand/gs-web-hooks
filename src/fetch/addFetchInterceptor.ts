...
// 创建拦截器管理器实例
const interceptorManager = new InterceptorManager(checkAndInstallFetch, getFetchInterceptors);
 ...
 * @returns 更新后的拦截器列表
 */
export function addFetchInterceptor(interceptor: IInterceptor): IRequiredInterceptor[] {
